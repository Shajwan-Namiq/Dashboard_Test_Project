...
const Sidebar = ({ flyer, setFlyer }) => {
  return (
    <>
      <div
        className={`mt-2 fixed flex flex-col top-14 left-0 w-14   
      ...
      >
        <div className="mt-5 overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
              ...
              >
                <span className="inline-flex justify-center items-center ml-4">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="w-5 h-5 feather feather-table"
                  >
          ...
          mb-16 px-5 py-3`}
          >
            <div className=" flex flex-col space-y-2 lg:space-y-0 lg:flex-row items-center lg:space-x-4 lg:p-5">
              <Link href="/">
                <svg
                  width="20"
                  height="20"
